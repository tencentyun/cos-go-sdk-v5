...
## [v0.7.75](https://github.com/tencentyun/cos-go-sdk-v5/compare/v0.7.74...v0.7.75) - 2026-07-24

1、CI 新增HDR图片处理服务开关接口；内容审核响应补充命中详情字段；支持大模型批量图片分析；支持文档预览和媒体17.9.0。
2、

### Merged

- 针对complete接口chunk回包错误增加重试 [`#354`](https://github.com/tencentyun/cos-go-sdk-v5/pull/354)
- support bucket stroage class [`#353`](https://github.com/tencentyun/cos-go-sdk-v5/pull/353)
- Feature wanjiewu 1500c3cf [`#352`](https://github.com/tencentyun/cos-go-sdk-v5/pull/352)
- feat(ci): 新增 HDR 图片处理服务开关接口 [`#351`](https://github.com/tencentyun/cos-go-sdk-v5/pull/351)
- Feature branshchen 9e8bc513 [`#350`](https://github.com/tencentyun/cos-go-sdk-v5/pull/350)
- Feature panqianghao 075a4c86 [`#349`](https://github.com/tencentyun/cos-go-sdk-v5/pull/349)

### Commits

- 支持文档预览和媒体17.9.0 [`a263ced`](https://github.com/tencentyun/cos-go-sdk-v5/commit/a263cedcf69ed426e9554bcfcc4142a1500c3cfd)
- 支持图片两个需求 [`ba8f476`](https://github.com/tencentyun/cos-go-sdk-v5/commit/ba8f4768ddef0c5643fa849bd9c46d9c14eac1df)
- feat(vector): list vectors filter field [`c1623a4`](https://github.com/tencentyun/cos-go-sdk-v5/commit/c1623a47cc2b0947ffe87459c556eb5a3497d8ba)
- Updated CHANGELOG.md [`d21acb2`](https://github.com/tencentyun/cos-go-sdk-v5/commit/d21acb295d34638a05ac02991d93f009f5fb930d)
- feat(ci): 内容审核响应补充命中详情字段 [`b4b57be`](https://github.com/tencentyun/cos-go-sdk-v5/commit/b4b57beb87de71e9e24673157041ad79d8bff628)

## [v0.7.74](https://github.com/tencentyun/cos-go-sdk-v5/compare/v0.7.73...v0.7.74) - 2026-06-10

1、支持向量桶API。
2、COS GetToFile和Download方法下载完成后sync刷盘，Download断点下载保证刷盘成功才更新进度文件。
3、CI 新增DocSearch模板及混合检索接口。

### Merged

- Feature jojoliang 5ed752d8 [`#348`](https://github.com/tencentyun/cos-go-sdk-v5/pull/348)
- 下载文件后需要sync刷盘 [`#347`](https://github.com/tencentyun/cos-go-sdk-v5/pull/347)
- Feature jojoliang 5cc5ee41 [`#345`](https://github.com/tencentyun/cos-go-sdk-v5/pull/345)
- Feature jojoliang 9668ac54 [`#344`](https://github.com/tencentyun/cos-go-sdk-v5/pull/344)
- fix(vector): validate list segment params and remove vector test tool [`#343`](https://github.com/tencentyun/cos-go-sdk-v5/pull/343)
- update version, 增加分块上传预签名demo [`#342`](https://github.com/tencentyun/cos-go-sdk-v5/pull/342)
- Feature jojoliang 73afbb7c [`#341`](https://github.com/tencentyun/cos-go-sdk-v5/pull/341)

### Commits

- feat: 新增向量桶(vector bucket)功能支持 [`376aa79`](https://github.com/tencentyun/cos-go-sdk-v5/commit/376aa794c77eb9dd1479b00dcfcb84f40ce12a17)
- fix: align vector bucket API implementation with official documentation [`4f918f7`](https://github.com/tencentyun/cos-go-sdk-v5/commit/4f918f7b06029eb1d9ca2d66d375e40070365e49)
- 断点文件在数据刷盘后再更新，确保断点数据正确 [`43d9e47`](https://github.com/tencentyun/cos-go-sdk-v5/commit/43d9e4791f9af59ba2f2f29f58b8e455ed752d8f)
- update error [`78ab8a2`](https://github.com/tencentyun/cos-go-sdk-v5/commit/78ab8a27d341794b23b54fb3ebaed865cc5ee41a)
- feat: MetaInsight新增DocSearch模板及混合检索接口HybridSearch [`f785f86`](https://github.com/tencentyun/cos-go-sdk-v5/commit/f785f86b0ea93cf32dba67dccdd1f549668ac54c)
- refactor: remove Qcs fields from Options structs, make bucket/index name required [`71f41bb`](https://github.com/tencentyun/cos-go-sdk-v5/commit/71f41bb0916c56fd2a38a85d6bb01e56d200c39c)
- Updated CHANGELOG.md [`74acbdd`](https://github.com/tencentyun/cos-go-sdk-v5/commit/74acbddc6afbf7ed99185b32a8e33ad0f9af1b58)
- fix: 显式处理 VectorErrorResponse.Error() 中 decodeURIComponent 的错误返回值 [`2b9952b`](https://github.com/tencentyun/cos-go-sdk-v5/commit/2b9952b48b7e46d610a887b46fec821a41d090fd)

## [v0.7.73](https://github.com/tencentyun/cos-go-sdk-v5/compare/v0.7.72...v0.7.73) - 2026-03-16

1、COS更新静态网站接口。
2、增加CAM匿名用户组和认证用户组常量。
3、高级上传下载接口提供输入输出管道参数，可由业务控制并发。
4、MultiCopy中Head请求保持和url相同scheme。
5、GetToFile接口增加CRC校验，Download使用分块CRC合并的方式校验。

### Merged

- Feature jojoliang 2e94bb5e [`#340`](https://github.com/tencentyun/cos-go-sdk-v5/pull/340)
- Feature jojoliang 9c109b4b [`#339`](https://github.com/tencentyun/cos-go-sdk-v5/pull/339)
- Feature jojoliang 2f9bb63b [`#336`](https://github.com/tencentyun/cos-go-sdk-v5/pull/336)

### Commits

- GetToFile增加CRC校验，Download使用分块CRC合并的方式校验 [`f3d4746`](https://github.com/tencentyun/cos-go-sdk-v5/commit/f3d4746b306e37f8bb70959e44c48962e94bb5e9)
- 1、增加CAM匿名用户组和认证用户组常量。2、高级上传下载接口提供输入输出管道参数，由业务控制并发。3、MultiCopy中Head请求保持和url相同scheme [`e76fbfe`](https://github.com/tencentyun/cos-go-sdk-v5/commit/e76fbfea9dd566921995f75dfea7b75b887a6d2c)
- Updated CHANGELOG.md [`f410f78`](https://github.com/tencentyun/cos-go-sdk-v5/commit/f410f780c6b11dbdb3acef5ce68956da7f027c83)
- 优化高级接口对外参数 [`bd55ae0`](https://github.com/tencentyun/cos-go-sdk-v5/commit/bd55ae078a1e68df0e712982e5a8a7b9c109b4b6)
- 更新静态网站接口参数 [`edbe9c0`](https://github.com/tencentyun/cos-go-sdk-v5/commit/edbe9c0b66bb3b48270e36c82f11e692f9bb63b3)
