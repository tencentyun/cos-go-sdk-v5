...
func getClient() *cos.Client {
	u, _ := url.Parse("https://test1-1253960454.cos.ap-beijing.myqcloud.com")
	metaInsight, _ := url.Parse("https://1253960454.ci.ap-beijing.myqcloud.com")
...
func CreateFileMetaIndex() {
	...
	opt := &cos.CreateFileMetaIndexOptions{
		DatasetName: "adataset",
		File: &cos.File{
			URI:      "cos://wwj-bj-1253960454/5.gif",
			CustomId: "123",
...
func UpdateFileMetaIndex() {
	...
	opt := &cos.UpdateFileMetaIndexOptions{
		DatasetName: "adataset",
		File: &cos.File{
			URI:      "cos://test1-1253960454/1.gif",
			CustomId: "123",
			CustomLabels: &map[string]string{
				"age":   "18",
				"level": "18",
...
func DatasetFaceSearch() {
	...
	opt := &cos.DatasetFaceSearchOptions{
		...
		URI:         "cos://bj-flynnzzhang-1253960454/face.jpeg",
	}
